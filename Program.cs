...
namespace _15._10
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //    var user =new User { Name ="Eugene",Age=17,Company=company1};
            //    var user2 = new User { Name = "Poul", Age = 71, Company = company2 };
            //    var user3 = new User { Name = "Jeka", Age = 66, Company = company2 };
            ...
            using (ApplicationContext db = new ApplicationContext())
            {
                ...
                //   END;
                //   """);
                //SqlParameter nameParam = new SqlParameter("@Name", "Poul");
